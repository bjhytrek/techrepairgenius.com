...
<?php $active_page
    ...
    <div id="services" class="row">
        ...
        <div class="col-xs-9 col-sm-8 col-md-8 col-lg-9">
            <div  class="well"><h3 id="button_output_heading"> Quick links to your most common issues!</h3><p  id="button_output_content"></p></div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-6 col-md-4">
            ...
            <div class="thumbnail">
                <a href="index.php?action=repairs" class="thumbnail" >
                    <img src="media/hardware_repairs.png" alt="Hardware Repairs">
                </a>
                <div class="caption">
        ...
        <div class="col-sm-6 col-md-4">
            <div class="thumbnail">
                <a href="index.php?action=repairs" class="thumbnail" >
                    <img src="media/software_repairs.jpg" alt="Software Repairs">
                </a>
                <div class="caption">
        ...
        <div class="col-sm-6 col-md-4">
            <div class="thumbnail">
                 <a href="index.php?action=custom_build" class="thumbnail" >
                     <img src="media/custom_built_computers.png" alt="Customer Built Computers">
                </a>
                <div class="caption">
